...
const MainContent = () => {
  ...
  return (
    <div className="px-6 text-neutral-400">
      {posts.length === 0 ? (
        <div className="border border-neutral-600 bg-neutral-900 mt-4 p-2 rounded-md cursor-pointer">
        ...
        posts.map((post) => (
          <div
            key={post._id}
            className="border border-neutral-600 bg-neutral-900 mt-4 p-4 rounded-md mb-4"
          >
            <h5 className="text-neutral-600 text-sm mb-2">
              Posted by user/{post?.author} on{" "}
